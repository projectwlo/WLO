...
export function FormCreditSimulator(props: FormCreditSimulatorProp) {
    ...
    const [simuladorCredito, setSimuladorCredito] = React.useState(0);
    ...
    const handleSendEmail = async () => {
        if (_.isEmpty(values.pws_cod_credi!) || _.isEmpty(values.Pws_Val_pla!) || _.isEmpty(values.Pws_Val_cuoini!) || _.isEmpty(values.Pws_Correo!)) {
            ...
            await WLOCreditAPIService.sendEmailModelo();
        }
    }
    ...
    return (
        <div className={'row'}>
            ...
            <div id={"model-product"} className={"title-large-red"}>{localStorage.getItem('R_s_nom_prod') || ''}</div>
            <div id={"price-product"} className={"title-large"}>{localStorage.getItem('R_s_precio_comer') || ''}</div>
            ...
            <div className={'flex-container-form-know-you'}>
                <div className={"flex-container-form-know-you-item-center flex-grow-8"}>
                    ...
                    <Field as="select"
                           id={"pws_cod_credi"}
                           className={'form-know-you-item-input-md'}
                           name="pws_cod_credi">
            ...
            <div className={'flex-container-form-know-you'}>
                <div className={"flex-container-form-know-you-item-right flex-grow-6"}>
                    ...
                    <Field id={"Pws_Val_cuoini"}
                           name={"Pws_Val_cuoini"}
                           placeholder={errors.Pws_Val_cuoini ? errors.Pws_Val_cuoini : intl.formatMessage({id: "placeholder_initial_quote_symbol"})}
            ...
            <div className={'flex-container-form-know-you'}>
                <div className={"flex-container-form-know-you-item-right flex-grow-6"}>
                    <div className={"label-input-right"}>{intl.formatMessage({id: "value_to_finance"})}</div>
                ...
                <div className={"flex-container-form-know-you-item-left flex-grow-6"}>
                    <div className={"label-input-left"}>{intl.formatMessage({id: "value_of_quote"})}</div>
