        ...
        <div className="row container-border">
            <div className="row">
                ...
                <div className="col">
                    ...
                    <div className={"label-fields-peps-mobile-ligth display-flex"}>{persona.Pws_Identificacion}</div>
                </div>
                <div className="col">
                    <div
            ...
            <div className="row">
                ...
                <div className="col">
                    ...
                    >
                        <option>{errors && errors.Pws_Departamento ? errors.Pws_Departamento : intl.formatMessage({id: "department"})}</option>
